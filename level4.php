...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse mx-5" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item mx-3">
          <a class="nav-link navlist" href="level2.php">Level 2</a>
        </li>
        <li class="nav-item mx-3">
          <a class="nav-link navlist" href="level3.php">Level 3</a>
        </li>
        <li class="nav-item mx-3">
          <a class="nav-link navlist" aria-current="page" href="level4.php" style="text-decoration: underline;">Level 4</a>
        </li>
      </ul>
      <form class="d-flex">
  ...
  <body>
    ...
    <div class="tablecontainer" id="append">
      <table class="table" id="table">
        ...
        <?php
            ...
            for($i=0;$i<10;$i++){
              echo "<tr>";
              echo "<th  style='width:20%; height:auto;'>".$qst[$i]."</th>";
              for($j=0;$j<10;$j++){
                    echo "<td class='data td10' id='".$id."' onclick='fun(this.id)'> </td>";
                    $id++;
                  }
                echo "</tr>";
              } 
    ...
    <script>
        ...
        var clicked= [<?php for($i=0;$i<100;$i++){echo "0,";} ?>];
        function fun(clicked_id)
        {
            if(lifes>0 && clicked[clicked_id]==0 && total>0){
                ...
                if (ans[clicked_id] == 1){
                    ...
                    obj.setAttribute("style", "background: url('wrong2.png'); background-position: center; max-width: 100%; height: auto; background-repeat: no-repeat");
                    if(lifes==0){
                ...
                if(total==0){
                  ...
                  img.setAttribute("src","level4.jpg");
